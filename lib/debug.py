...
@click.option('--first_name',type=str,required=True,prompt="Enter first name") 
@click.option('--last_name',type=str,required=True,prompt="Enter last name") 
...
def new_student(first_name,last_name,date_of_admission):
    ...
    student.create_student(**new_stud)       
all_methods.add_command(new_student)

@click.command(help="Update student")
@click.option('--id',type=int,required=True,prompt="Enter Student id ") 
@click.option('--first_name',type=str,required=True,prompt="Enter first name ") 
@click.option('--last_name',type=str,required=True,prompt="Enter last name ") 
@click.option('--date_of_admission',required=True, prompt="Enter date of admission ")
...
@click.option('--first_name',type=str,required=True,prompt="Enter first name")
@click.option('--last_name',type=str,required=True,prompt="Enter last name")
@click.option('--subject',type=str,required=True,prompt="Enter subject")
...
@click.option('--id',type=int,required=True,prompt="Enter Teacher id ") 
@click.option('--first_name',type=str,required=True,prompt="Enter first name ") 
@click.option('--last_name',type=str,required=True,prompt="Enter last name ") 
@click.option('--subject',type=str,required=True, prompt="Enter subject ")
...
@click.option('--name',type=str,required=True,prompt="Enter Class name ")
@click.option('--teachers_id',type=int,required=True,prompt="Enter Teacher id ")
@click.option('--students_id',type=int,required=True,prompt="Enter Student id ")
def new_class(name,teachers_id,students_id):
    new={
        "name":name,
        "teachers_id":teachers_id,
        "students_id":students_id
    }
    classes.create_class(**new)
...
@click.option('--id',type=int,required=True,prompt="Enter Class id ") 
@click.option('--name',type=str,required=True,prompt="Enter Class name ") 
@click.option('--teachers_id',type=int,required=True,prompt="Enter teachers id ") 
@click.option('--students_id',type=int,required=True,prompt="Enter students id ") 
